...
/**
 * This function read training points from point_file, and the function is overloaded to two version, one for store training vector in \
 * and one for storing vectors in array
